...
export const uk = {
  ...
  booking: {
    title: "Запит на вечерю",
    intro:
      "Розкажіть, коли і для скількох гостей — шеф зв'яжеться з вами й допоможе скласти меню.",
    submit: "Надіслати запит",
    thanksTitle: "Дякуємо, запит надіслано.",
    thanksBody: "Шеф зв'яжеться з вами найближчим часом.",
    close: "Закрити",
  },
  checkout: {
    name: "Імʼя",
